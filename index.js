...
async function run() {
    ...
    try {
        ...
        let command = (`docker run -e http_proxy=http://proxy.dstcorp.net:9119 -e https_proxy=http://proxy.dstcorp.net:9119 -e no_proxy=.dstcorp.net,.ssnc.global,ssnc-portal.cloud,.ssnc-corp.cloud,.ssnc.cloud,localhost --user root -v ${workspace}:/zap/wrk/:rw --network="host" ` +
